...
{
    [CreateAssetMenu(menuName = "Character/LineAttackCharacter", fileName = "LineAttackCharacter")]
    public class AllLineAttackCharacter: CharacterScriptable
    {
        [SerializeField]
        ...
        public override ICharacterAttack GetAttack()
        {
            ...
            return new CharacterLineAttack(damageDealer, true);
        }
    }
}